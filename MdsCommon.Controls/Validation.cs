...
namespace MdsCommon.Controls
{
    public static partial class Validation
    {
        ...
        public static void SetValidation(this SyntaxBuilder b, Var<State> validationState, Var<string> id, Var<string> message)
        {
        ...
        public static void ClearValidation(this SyntaxBuilder b, Var<State> validationState, Var<string> id)
        {
        ...
        public static Var<string> GetValidation(this SyntaxBuilder b, Var<State> validationState, Var<string> id)
        {
        ...
        public static Var<bool> IsValid(this SyntaxBuilder b, Var<State> validationState, Var<string> id)
        {
            return b.Not(b.HasError(validationState, id));
        }

        public static Var<bool> HasError(this SyntaxBuilder b, Var<State> validationState, Var<string> id)
        {
            return b.HasValue(b.GetValidation(validationState, id));
        }

        public static Var<bool> AllValid(this SyntaxBuilder b, Var<State> validationState)
        {
