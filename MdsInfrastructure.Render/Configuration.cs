...
namespace MdsInfrastructure.Render
{
    public static class Configuration
    {
        public class List : MixedHyperPage<ListConfigurationsPage, ConfigurationHeadersList>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, ListConfigurationsPage serverModel, Var<ConfigurationHeadersList> clientModel)
            {
        ...
        public class Edit : MixedHyperPage<EditConfigurationPage, EditConfigurationPage>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, EditConfigurationPage serverModel, Var<EditConfigurationPage> clientModel)
            {
                b.AddModuleStylesheet();
        ...
        public class Review : MixedHyperPage<ReviewConfigurationPage, ReviewConfigurationPage>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, ReviewConfigurationPage serverModel, Var<ReviewConfigurationPage> clientModel)
            {
                b.AddModuleStylesheet();
