...
namespace MdsInfrastructure.Render
{
    public static class Docs
    {
        public class Service : MixedHyperPage<M.ServicePage, M.ServicePage>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, M.ServicePage serverModel, Var<M.ServicePage> clientModel)
            {
        ...
        public class RedisMap : MixedHyperPage<M.RedisMap, M.RedisMap>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, M.RedisMap serverModel, Var<M.RedisMap> clientModel)
            {
                b.AddModuleStylesheet();
