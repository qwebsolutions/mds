...
namespace MdsInfrastructure.Render
{
    public static class Node
    {
        public class List : MixedHyperPage<M.List, M.List>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, M.List serverModel, Var<M.List> clientModel)
            {
        ...
        public class Edit : MixedHyperPage<M.EditPage, M.EditPage>
        {
            ...
            public override Var<HyperNode> OnRender(LayoutBuilder b, M.EditPage serverModel, Var<M.EditPage> clientModel)
            {
