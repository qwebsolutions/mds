    ...
    public static partial class EditConfiguration
    {
            ...
            Var<Guid> serviceId)
        {
            ...
            var addCommand = b.MakeAction((BlockBuilder b, Var<EditConfigurationPage> state) =>
            {
                ...
                b.GoTo(clientModel, EditNote, newNote);
            ...
            var rc = b.RenderCell<InfrastructureServiceNote>(
                        (b, row, col) =>
                        {
                            ...
                            return b.VPadded4(b.Switch(b.Get(col, x => x.Name),
                                b => b.Link(noteTypeLabel, b.MakeAction((BlockBuilder b, Var<EditConfigurationPage> clientModel) => b.GoTo(clientModel, EditNote, row))),
