    ...
    public static partial class EditConfiguration
    {
            ...
            Var<Guid> serviceId)
        {
            var onAddParameter = b.MakeAction((BlockBuilder b, Var<EditConfigurationPage> clientModel) =>
            {
                ...
                return b.GoTo(clientModel, EditParameter, newParam);
            });
            ...
            var rc= b.RenderCell<InfrastructureServiceParameterDeclaration>(
                        (b, row, col) =>
                        {
                            ...
                            return b.VPadded4(b.Switch(
                                b.Get(col, x => x.Name),
                                b => b.Link(b.Get(row, x => x.ParameterName, "(not set)"), b.MakeAction<EditConfigurationPage>((b, clientModel) => b.GoTo(clientModel, EditParameter, row))),
